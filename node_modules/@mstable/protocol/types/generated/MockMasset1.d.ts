...
export interface MockMasset1Contract
  extends Truffle.Contract<MockMasset1Instance> {
  "new"(
    _name: string,
    _symbol: string,
...
export interface MockMasset1Instance extends Truffle.ContractInstance {
  addMinter: {
