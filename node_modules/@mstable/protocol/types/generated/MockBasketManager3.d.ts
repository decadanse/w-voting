...
export interface MockBasketManager3Contract
  extends Truffle.Contract<MockBasketManager3Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<MockBasketManager3Instance>;
}
...
export interface MockBasketManager3Instance extends Truffle.ContractInstance {
  addBasset: {
    (
      _bAsset: string,
      _integration: string,
  ...
  mAsset(txDetails?: Truffle.TransactionDetails): Promise<string>;
