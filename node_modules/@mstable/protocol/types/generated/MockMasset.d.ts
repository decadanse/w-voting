...
export interface MockMassetContract
  extends Truffle.Contract<MockMassetInstance> {
  "new"(
    _name: string,
    _symbol: string,
...
export interface MockMassetInstance extends Truffle.ContractInstance {
  addMinter: {
