...
export interface MockInitializableModuleContract
  extends Truffle.Contract<MockInitializableModuleInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<MockInitializableModuleInstance>;
}

type AllEvents = never;

export interface MockInitializableModuleInstance
  ...
  metaToken(txDetails?: Truffle.TransactionDetails): Promise<string>;
