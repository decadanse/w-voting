...
export interface MockBasketManager1Contract
  extends Truffle.Contract<MockBasketManager1Instance> {
  "new"(
    _bAsset: string,
    meta?: Truffle.TransactionDetails
  ): Promise<MockBasketManager1Instance>;
}
...
export interface MockBasketManager1Instance extends Truffle.ContractInstance {
  addBasset: {
    (
      _bAsset: string,
      _integration: string,
